...
export const BoxLateral = styled.div`
    ...
    box-shadow: rgb(255, 122, 113) 4px 0px 5px;
    padding-left: 10px;
    ...
    box-shadow: rgb(255, 122, 113) 2px 0px 3px;
    padding-left: 10px;
    }
...
export const BoxLateralCarrinho = styled.div`
    ...
    button{
        background-color: rgb(255, 122, 113);
        border-radius: 8px;
        font-size: 16px;
        color: white;
        width: 100%;
...
display: flex;
  ...
  border-radius: 0px 0px 200px 200px;
    :hover{
        box-shadow: rgb(255, 122, 113) 0px 20px 40px;
...
export const Img = styled.img`
    border-radius: 20px 20px 30px 1px;
    padding: 5px ;
    ...
    :hover{
        box-shadow: rgb(255, 122, 113) -4px 0px 50px;
